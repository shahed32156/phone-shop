...
import OnePlus_data_set from './OnePlus_data_set';

const OnePLus = () => {

    const navigate = useNavigate();     
    const [catagory, setCatagory] = useState("OnePlus");

    let items = [];

items = Data.map((item,index) => <OnePlus_data_set key={index} img={item.img} title={item.title}
