...
import Samsung_data_set from './Samsung_data_set';

const Samsung = () => {

    const navigate = useNavigate();     
    const [catagory, setCatagory] = useState("Samsung");

    let items = [];

items = Data.map((item,index) => <Samsung_data_set key={index} img={item.img} title={item.title}
