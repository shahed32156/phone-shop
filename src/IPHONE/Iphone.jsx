...
import Iphone_data_set from './Iphone_data_set';
import { useNavigate } from 'react-router-dom';

const Iphone = () => {

    const navigate = useNavigate();     
    const [catagory, setCatagory] = useState("iPhone");

    let items = [];

items = Data.map((item,index) => <Iphone_data_set key={index} img={item.img} title={item.title}
