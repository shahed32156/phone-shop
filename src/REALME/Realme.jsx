...
import Realme_data_set from './Realme_set_data';

const Realme = () => {

    const navigate = useNavigate();     
    const [catagory, setCatagory] = useState("Realme");

    let items = [];

items = Data.map((item,index) => <Realme_data_set key={index} img={item.img} title={item.title}
