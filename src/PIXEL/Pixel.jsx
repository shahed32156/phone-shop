...
import Pixel_data_set from './Pixel_data_set';

const Pixel = () => {

    const navigate = useNavigate();     
    const [catagory, setCatagory] = useState("Pixel");

    let items = [];

items = Data.map((item,index) => <Pixel_data_set key={index} img={item.img} title={item.title}
